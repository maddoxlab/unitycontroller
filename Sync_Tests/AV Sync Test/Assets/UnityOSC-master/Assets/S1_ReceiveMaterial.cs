...
public class S1_ReceiveMaterial : MonoBehaviour {
    
   	public OSC osc;

    // Use this for initialization
    void Start () {
	    osc.SetAddressHandler("/Sphere1_Color" , OnReceiveColor);
        osc.SetAddressHandler("/Sphere1_Alpha", OnReceiveAlpha);
        osc.SetAddressHandler("/Sphere1_Visible", OnReceiveVisible);
    }
