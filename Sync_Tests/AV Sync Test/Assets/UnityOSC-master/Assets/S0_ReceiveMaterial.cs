...
public class S0_ReceiveMaterial : MonoBehaviour {
    
   	public OSC osc;

    // Use this for initialization
    void Start () {
	    osc.SetAddressHandler("/Sphere0_Color" , OnReceiveColor);
        osc.SetAddressHandler("/Sphere0_Alpha", OnReceiveAlpha);
        osc.SetAddressHandler("/Sphere0_Visible", OnReceiveVisible);
    }
