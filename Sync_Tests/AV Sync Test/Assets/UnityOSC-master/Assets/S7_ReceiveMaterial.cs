...
public class S7_ReceiveMaterial : MonoBehaviour {
    
   	public OSC osc;

    // Use this for initialization
    void Start () {
	    osc.SetAddressHandler("/Sphere7_Color" , OnReceiveColor);
        osc.SetAddressHandler("/Sphere7_Alpha", OnReceiveAlpha);
        osc.SetAddressHandler("/Sphere7_Visible", OnReceiveVisible);
    }
