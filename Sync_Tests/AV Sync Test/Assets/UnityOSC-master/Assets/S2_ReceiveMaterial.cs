...
public class S2_ReceiveMaterial : MonoBehaviour {
    
   	public OSC osc;

    // Use this for initialization
    void Start () {
	    osc.SetAddressHandler("/Sphere2_Color" , OnReceiveColor);
        osc.SetAddressHandler("/Sphere2_Alpha", OnReceiveAlpha);
        osc.SetAddressHandler("/Sphere2_Visible", OnReceiveVisible);
    }
