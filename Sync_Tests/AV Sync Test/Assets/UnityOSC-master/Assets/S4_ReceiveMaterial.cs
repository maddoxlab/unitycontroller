...
public class S4_ReceiveMaterial : MonoBehaviour {
    
   	public OSC osc;

    // Use this for initialization
    void Start () {
	    osc.SetAddressHandler("/Sphere4_Color" , OnReceiveColor);
        osc.SetAddressHandler("/Sphere4_Alpha", OnReceiveAlpha);
        osc.SetAddressHandler("/Sphere4_Visible", OnReceiveVisible);
    }
