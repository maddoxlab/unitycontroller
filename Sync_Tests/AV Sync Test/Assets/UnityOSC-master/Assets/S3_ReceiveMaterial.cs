...
public class S3_ReceiveMaterial : MonoBehaviour {
    
   	public OSC osc;

    // Use this for initialization
    void Start () {
	    osc.SetAddressHandler("/Sphere3_Color" , OnReceiveColor);
        osc.SetAddressHandler("/Sphere3_Alpha", OnReceiveAlpha);
        osc.SetAddressHandler("/Sphere3_Visible", OnReceiveVisible);
    }
