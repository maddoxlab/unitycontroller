...
public class S2_ReceiveProperties : MonoBehaviour {
	...
	void Start () {
	    osc.SetAddressHandler("/UnityShape2", OnReceiveParams);
    }
	...
	void OnReceiveParams(OscMessage message){
        ...
        transform.rotation = new Quaternion(rot_x, rot_y, rot_z, 360);
